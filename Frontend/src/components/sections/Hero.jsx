  ...
  return (
    <>
      ...
      <section
        id="home"
        ref={containerRef}
        className="section-padding !pt-6 relative min-h-screen flex items-center overflow-hidden grid-bg bg-hero"
      >
        <Particles />
        ...
        <div className="max-w-7xl mx-auto w-full pt-0 pb-16">
